...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { autor: @producto.autor, categoria: @producto.categoria, descripcion: @producto.descripcion, estado: @producto.estado, fecha_baja: @producto.fecha_baja, fecha_ingreso: @producto.fecha_ingreso, fecha_modificacion: @producto.fecha_modificacion, tipo: @producto.tipo, precio: @producto.precio, stock: @producto.stock, titulo: @producto.titulo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { autor: @producto.autor, categoria: @producto.categoria, descripcion: @producto.descripcion, estado: @producto.estado, fecha_baja: @producto.fecha_baja, fecha_ingreso: @producto.fecha_ingreso, fecha_modificacion: @producto.fecha_modificacion, tipo: @producto.tipo, precio: @producto.precio, stock: @producto.stock, titulo: @producto.titulo } }
